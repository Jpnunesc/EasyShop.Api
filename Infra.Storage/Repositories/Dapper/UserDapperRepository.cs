...
{
    public class UserDapperRepository : BaseDapperRepository<MarketplaceDapperContext, UserEntity>, IUserDapperRepository
    {
        public UserDapperRepository(MarketplaceDapperContext session) : base(session)
        {
        }
