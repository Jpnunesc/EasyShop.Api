...
{
    public abstract class BaseDapperRepository<IDbConnection, TEntity> : IBaseDapperRepository<TEntity> where TEntity : IAggregateRoot where IDbConnection : MarketplaceDapperContext
    {
